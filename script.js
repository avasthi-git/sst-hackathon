(function () {
    ...
    onvisible.add("#container02", { style: "fade-up", speed: 1000, intensity: 5, delay: 0, replay: false });
    onvisible.add("#container02 > .wrapper > .inner", { style: "fade-in", speed: 1000, intensity: 10, delay: 500, replay: false });
    onvisible.add(".container.style1", { style: "zoom-in", speed: 1000, intensity: 5, delay: 0, replay: false });
})();
